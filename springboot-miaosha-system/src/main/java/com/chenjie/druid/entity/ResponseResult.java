...
public class ResponseResult<E> implements Serializable {
    ...
    public static <E> ResponseResult<E> buildResponseResult(ResCodeEnum resCodeEnum,Object ... args) {
        return new ResponseResult<E>(resCodeEnum.code,MessageFormat.format(resCodeEnum.msg,args));
    }
    ...
    public static <E> ResponseResult<E> buildResponseResult(ResCodeEnum resCodeEnum, E data, Page page) {
        return new ResponseResult<E>(resCodeEnum.code, resCodeEnum.msg, data, page);
    }
